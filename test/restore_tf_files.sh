...
function envs(){
    # restore backend configs in main module
    mv 2-environments/envs/sandbox/backend.tf.disabled  2-environments/envs/sandbox/backend.tf
...
function networks(){
    ...
    # restore backend configs in main module
    mv $network_dir/envs/sandbox/backend.tf.disabled  $network_dir/envs/sandbox/backend.tf
    ...
    mv $network_dir/envs/sandbox/access_context.auto.tfvars.disabled  $network_dir/envs/sandbox/access_context.auto.tfvars
    ...
    mv $network_dir/envs/sandbox/common.auto.tfvars.disabled  $network_dir/envs/sandbox/common.auto.tfvars
...
function projects(){
    # restore backend configs in main module
    mv 4-projects/business_unit_1/sandbox/backend.tf.disabled 4-projects/business_unit_1/sandbox/backend.tf
    ...
    # restore access_context.auto.tfvars in main module
    mv 4-projects/business_unit_1/sandbox/access_context.auto.tfvars.disabled 4-projects/business_unit_1/sandbox/access_context.auto.tfvars
    ...
    mv 4-projects/business_unit_1/sandbox/business_unit_1.auto.tfvars.disabled 4-projects/business_unit_1/sandbox/business_unit_1.auto.tfvars
    ...
    mv 4-projects/business_unit_1/sandbox/sandbox.auto.tfvars.disabled 4-projects/business_unit_1/sandbox/sandbox.auto.tfvars
    ...
    # restore common.auto.tfvars in main module
    mv 4-projects/business_unit_1/sandbox/common.auto.tfvars.disabled 4-projects/business_unit_1/sandbox/common.auto.tfvars
...
function appinfra(){
    # restore backend configs in main module
    mv 5-app-infra/business_unit_1/sandbox/backend.tf.disabled 5-app-infra/business_unit_1/sandbox/backend.tf
    ...
    # restore ENVS.auto.tfvars in main module
    mv 5-app-infra/business_unit_1/sandbox/bu1-sandbox.auto.tfvars.disabled 5-app-infra/business_unit_1/sandbox/bu1-sandbox.auto.tfvars
    ...
    # restore common.auto.tfvars in main module
    mv 5-app-infra/business_unit_1/sandbox/common.auto.tfvars.disabled 5-app-infra/business_unit_1/sandbox/common.auto.tfvars
